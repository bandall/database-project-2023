...
import com.ajousw.spring.domain.auth.jwt.security.JwtAccessDeniedHandler;
import com.ajousw.spring.domain.auth.jwt.security.JwtAuthenticationEntryPoint;
import com.ajousw.spring.domain.auth.jwt.security.JwtFilter;
...
public class SecurityConfig {
    ...
    private final String[] anonymousUrl = {"/test/**"};
